            ...
            if det is not None and len(det):
                ...
                if len(outputs[i]) > 0:
                    for j, (output, conf) in enumerate(zip(outputs[i], confs)):
                        ...
                        bboxes = output[0:4] # xyxy
                        id = output[4]
                        cls = output[5]

                        # get transformed bboxes
                        cxcy = get_trans_point(bboxes, matrix)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='./data/toll_gate.mp4', help='file/dir/URL/glob, 0 for webcam')  
    ...
    parser.add_argument('--save-result', action='store_true', default=True, help='save tracking video results')
